            ...
            try
            {
                ...
                switch (p.PaginasTap)
                {
                    ...
                    default: 
                        ...
                        if (Convert.ToInt32(p.GramajeTapas) >= 130)
                        {
                            Barniz = "<tr><td class='style1'><div style='font-weight: bold;' align='right'>Terminación Tapa:</div></td><td colspan='2' class='style1'>Barniz Acuoso Parejo en Tiro.</td></tr>";
                        }
                        break;
                }
                ...
                {
                    case "JUMBO": p.Empresa = "Supermercado Jumbo"; break;
                    default: p.Empresa = "Supermercado Santa Isabel"; break;
                }
                ...
                if (tiraje1 != null)
                {
                    if (p.Tiraje2 == null && p.Tiraje3 == null)
                    {
                        TextoCantidad = "Cantidad de Ejemplares:";
                        TextoTotalNeto = "Total Neto:";
                    }
                    else
                    {
                        if (p.Tiraje2 != null && p.Tiraje3 != null)
                ...
                PPTO_Tirajes tiraje2 = p.Tiraje2;
                string Tiraje2Totales = "";
                if (tiraje2 != null)
                {
                    if (p.Tiraje1 == null && p.Tiraje3 == null)
                    {
                        TextoCantidad = "Cantidad de Ejemplares:";
                        TextoTotalNeto = "Total Neto:";
                    }
                    ...
                    Tiraje2Totales = "<tr>" +
                                    "<td style='100px'></td>" +
                                    "<td>" +
                                        "<div style='font-weight: bold;with:100;' align='right'>" +
                                            TextoCantidad+"</div>" +
                                    "</td>" +
                                    "<td>" +
                                        Convert.ToInt32(tiraje2.Cantidad).ToString("N0").Replace(",", ".") +
                                    "</td>" +
                                    "<td style='width: 1%;'>" +
                                        "<div align='right'>" +
                                            "<a style='font-weight: bold;'>" + "Total Neto:" + "</a> $ " + Convert.ToInt32(tiraje2.CostoTotal).ToString("N0").Replace(",", ".") +
                                        "</div>" +
                                    "</td>" +
                                "</tr>";
                }
                PPTO_Tirajes tiraje3 = p.Tiraje3;
                string Tiraje3Totales = "";
                if (tiraje3 != null)
                {
                    if (p.Tiraje1 == null && p.Tiraje2 == null)
                    {
                        TextoCantidad = "Cantidad de Ejemplares:";
                        TextoTotalNeto = "Total Neto:";
                    }
                    ...
                    Tiraje3Totales = "<tr>" +
                                    ...
                                    "</td>" +
                                    "<td>" +
                                        Convert.ToInt32(tiraje3.Cantidad).ToString("N0").Replace(",", ".") +
                                    "</td>" +
                                    "<td style='width: 1%;'>" +
                                        "<div align='right'>" +
                                            "<a style='font-weight: bold;'>" + "Total Neto:" + "</a> $ " + Convert.ToInt32(tiraje3.CostoTotal).ToString("N0").Replace(",", ".") +
                                        "</div>" +
                                    "</td>" +
                                "</tr>";
                }
        ...
        "<div style='font-size: 9px;'>"+
            "<table style='width: 100%;'>"+
                "<tr><td>"+
                    ...
                    "</td></tr><tr><td>"+
                        "<div style='font-weight: bold;' align='right'>"+
                            "Atención a:</div></td><td></td><td style='width: 1%;'></td></tr>"+
                "<tr>"+
                    "<td>"+
                        "<div style='font-weight: bold;' align='right'>"+
                ...
                "<tr>"+
                    "<td>"+
                        "<div style='font-weight: bold;' align='right'>"+
                            "<u>Observaciones:</u> </div>" +
                    "</td>"+
                    "<td colspan='2' style='font-weight: bold;'>"+
                        "Valor no incluye Pre Prensa." +
                    "</td>"+
                "</tr>"+
                ...
                "<tr>" +
                    ...
                    "<td style='font-weight: bold;'>" +
                        "Valor no incluye Preparación de Pedido" +
                    "</td>" +
                "</tr>" +
                "<tr>" +
                    "<td style='width: 100;'>" +
