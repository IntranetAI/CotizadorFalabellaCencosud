<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="Cotizador_Cencosud.ModuloUsuario.View.Login" %>
        ...
        <div style="max-width: 600px;margin-top:10%;">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div>
                        <img src="../../Estructura/Image/Logo_Jumbo_Cencosud.png" width="180px"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <img src="../../Estructura/Image/Logo_Santa_Isabel_Cencosud.png" width="150px"/>
                    </div>
                </div>
            </div>
        </div>
