<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="Cotizador_Falabella.ModuloUsuario.View.Login" %>
...
<head id="Head1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        var txt = "AImpresores Presupuestador Holding Falabella ";
        var espera = 1000;
        var refresca = null;
        function titulo() {
            document.title = txt;
        ...
        <div style="max-width: 600px;margin-top:10%;">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div>
                        <img src="../../Estructura/Image/Logo_Falabella.png" width="180px"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <img src="../../Estructura/Image/Logo_Sodimac.png" width="150px"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <img src="../../Estructura/Image/Logo_Tottus.png" width="150px"/>
